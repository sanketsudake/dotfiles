...
ffmpeg -hide_banner -loglevel error -y -ss 30 -i src.mov -frames:v 1 frame30.png
ffmpeg -hide_banner -loglevel error -y -i frame30.png -vf "crop=iw:160:0:0,scale=iw:320" chrome-top.png
echo "montage.png (one frame per 20 s), frame30.png (full size), chrome-top.png (top 160 px, 2x): measure the browser chrome height here"
